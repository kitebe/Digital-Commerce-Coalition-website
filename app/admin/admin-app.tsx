          ...
          <section className="cms-editor-view">
            ...
            <div className="cms-editor-layout">
              ...
              <aside className="cms-editor-aside">
                <section><p className="cms-aside-label">Publishing</p><dl><div><dt>Status</dt><dd><i className={`cms-status-badge is-${itemStatus(draft)}`}>{itemStatus(draft)}</i></dd></div><div><dt>Last updated</dt><dd>{formatUpdatedAt(draft.updatedAt)}</dd></div><div><dt>Collection</dt><dd>{activeConfig?.label}</dd></div></dl></section>
